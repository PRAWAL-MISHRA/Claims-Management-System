...
insert into policy (policy_id,policy_number,benefit_id,premium,tenure) values(1,101,202,6000.0,21);
...
insert into member_policy (member_id,policy_id,policy_number,benefit_id,subscription_date,tenure,cap_amount_benefits) values(4,1,101,202,'2021-06-24',21,100000.00);
...
insert into member_policy (member_id,policy_id,policy_number,benefit_id,subscription_date,tenure,cap_amount_benefits) values(2,1,101,201,'2020-03-07',25,120000.00);
...
insert into member_premium (member_id,policy_id,paid_date,due_date,premium,late_payment,late_payment_charges) values(1,1,'2021-07-09','2021-08-13',6000.0,false,0.0);
insert into member_premium (member_id,policy_id,paid_date,due_date,premium,late_payment,late_payment_charges) values(2,1,'2020-04-09','2020-05-13',5000.0,false,0.0);
...
insert into member_claim (policy_id,member_id,claim_id,provider_id,benefit_id,total_billed_amount,total_claimed_amount,claim_status,claim_description) values(1,1,1,1,202,90000.0,80000.0,'Claim in Process','City Hospital Medical Claim');

insert into member_claim (policy_id,member_id,claim_id,provider_id,benefit_id,total_billed_amount,total_claimed_amount,claim_status,claim_description) values(1,2,3,2,201,42000.0,42000.0,'claim Sanctioned','LIC monthly checkup claim');
