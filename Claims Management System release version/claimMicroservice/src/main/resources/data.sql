...
insert into claim (claim_id,amount_claimed,amount_settled,benefit_id,claim_status,member_id,policy_id,provider_id,description) values(1,80000.0,75000.0,202,'Claim in process',1,1,1,'City Hospital Medical Claim');
insert into claim (claim_id,amount_claimed,amount_settled,benefit_id,claim_status,member_id,policy_id,provider_id,description) values(3,42000.0,42000.0,201,'claim Sanctioned',2,1,2,'LIC monthly Checkup Claim');
