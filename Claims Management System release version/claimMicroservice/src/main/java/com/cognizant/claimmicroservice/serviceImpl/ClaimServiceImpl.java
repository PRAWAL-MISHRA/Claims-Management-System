...
public class ClaimServiceImpl implements ClaimService {
	 ...
	 */
	@Override
	public Claim processSubmitClaim(Integer claimId,Integer policyId,  Integer memberId, Integer providerId, Integer benefitId,
	...
	int c = (int) claimRepository.count();
		if (claimedAmount <= eligibleClaimAmount1) {

			if (claimedAmount > totalAmount) {
				claimObj = new Claim( c+1,"Under Dispute",
			...
			claimObj = new Claim(c+1, "Pending Action",
			...
			claimObj = new Claim( c+1,"Claim Rejected", "Claim Amount is greater than the eligible claim Amount",
