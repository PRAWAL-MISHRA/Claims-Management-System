...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public void springHandleMembertNotFound(HttpServletResponse response) throws IOException {
		...
		response.sendError(HttpStatus.BAD_REQUEST.value(), "provider Id is not found............global");
	}
	...
	public void springHandleClaimtNotFound(HttpServletResponse response) throws IOException {
		response.sendError(HttpStatus.BAD_REQUEST.value(), "claimId is not found............global");
	}
