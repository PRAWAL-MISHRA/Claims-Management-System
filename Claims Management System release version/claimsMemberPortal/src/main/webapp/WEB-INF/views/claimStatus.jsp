    ...
    <div class="container">
      <div class="card login-card">
        <div class="row no-gutters">
          <div class="col-md-5">
            <img src="https://i.ibb.co/YRFDQGj/claimform.jpg" style="width: 70%; height: 70%; margin:90px;"> 
          </div>
          <div class="col-md-7">
            <div class="card-body">
              <div class="brand-wrapper">
                <h1 style="text-align: center;"><a class="navbar-brand" style="font-style: inherit; font-size: 2rem; color:#212529;"><b style="font-family:arial;font-weight: bold;">  <img src="https://i.ibb.co/mzRDTjk/logo1.png" style = "margin-right:20px;" width="70" height="70" >Show your Claim</b></a></h1>
              </div>
             	<p align="center" class="display-4">${Message}</p>
					<p align="center" class="text-muted mb-4"></p>
                  <div class="form-group" id="Claim Id">
          
                      <input type="number" name="claim_id" id="claim_id" class="form-control" pattern="[0-9]{1,8}" placeholder="Claim Id" required/>
                  </div>
                  <div class="form-group" id="Policy Id">
              
                    <input type="number" name="policy_id" id="policy_id" class="form-control" pattern="[0-9]{1,8}" placeholder="Policy Id" required/>
                  </div>
